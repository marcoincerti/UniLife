...
class SocialPage extends StatefulWidget {
  ...
  const SocialPage({Key key, this.auth}) : super(key: key);
  ...
  Stream getData2() {
    ...
    switch (segmentedControlGroupValue) {
      ...
      case 2:
        ...
        break;
      case 3:
        return FirebaseFirestore.instance.collection('users').doc(widget.auth.currentUser.uid).collection('social').snapshots();
        break;
    }
  }
