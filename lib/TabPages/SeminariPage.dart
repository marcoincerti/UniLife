...
import 'package:flutter_app4/TabPages/SinglePage.dart';
  ...
  Stream getData2() {
    ...
    switch (segmentedControlGroupValue) {
      ...
      case 2:
        ...
        break;
      case 3:
        return FirebaseFirestore.instance.collection('users').doc(widget.auth.currentUser.uid).collection('seminari').snapshots();
        break;
    }
  }
